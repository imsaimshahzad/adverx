...
function AdminRoute() {
  ...
  const metrics = useMemo(
    () => [
      ...
      { label: "Gross plan sales", value: Number(overview.gross_plan_sales ?? 0) },
  ...
  { label: "Referral Rewards", value: Number(overview.total_referral_commissions ?? 0) },
