...
revoke execute on function public.admin_adjust_ledger(uuid,numeric,text) from anon, authenticated;
revoke execute on function public.admin_adjust_user_reserve(uuid,numeric,text) from anon, authenticated;
revoke execute on function public.admin_approve_deposit(uuid,text,text) from anon, authenticated;
grant execute on function public.admin_approve_deposit(uuid,text,text) to authenticated;
revoke execute on function public.admin_broadcast_notification(text,text) from anon, authenticated;
revoke execute on function public.admin_dispatch_notification(uuid,text,text) from anon, authenticated;
revoke execute on function public.admin_profit_ledger_page() from anon, authenticated;
revoke execute on function public.admin_profit_summary() from anon, authenticated;
revoke execute on function public.admin_remove_user(uuid) from anon, authenticated;
revoke execute on function public.admin_reply_support_ticket(uuid,text,text) from anon, authenticated;
revoke execute on function public.admin_set_user_status(uuid,text) from anon, authenticated;
revoke execute on function public.admin_transition_withdrawal(uuid,text) from anon, authenticated;
revoke execute on function public.admin_use_recovery_fund(numeric,text,uuid,text,text) from anon, authenticated;
revoke execute on function public.admin_users_page(text,text,integer,integer) from anon, authenticated;
...
revoke execute on function public.reverse_approved_purchase(uuid,text) from anon, authenticated;
revoke execute on function public.review_withdrawal(uuid,text,text) from anon, authenticated;
